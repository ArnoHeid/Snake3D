...
var windowWidth;
var windowHeight;
var spaceTreeColors = [0xa17c04, 0xffa500, 0x0205fa, 0xf8093b, 0x93f154];
var firstTime = true;
var foodCount = 0;
...
function init() {
    ...
    function spawnSpaceTrees() {
        ...
        if (checkForSnake(vector)) {
            spaceTree.position.x = spaceTree.position.x + 4;
            spaceTree.position.z = spaceTree.position.z + 4;
        }
        ...
        vector = new THREE.Vector3(spaceTree.position.x + sphere.position.x, spaceTree.position.y + sphere.position.y, spaceTree.position.z + sphere.position.z);
        if (checkForSnake(vector)) {
            spaceTree.position.x = spaceTree.position.x + 4;
            spaceTree.position.z = spaceTree.position.z + 4;
        }
        ...
        vector = new THREE.Vector3(spaceTree.position.x + sphere.position.x + newSphere.position.x, spaceTree.position.y + sphere.position.y + newSphere.position.y, spaceTree.position.z + sphere.position.z + newSphere.position.z);
        if (checkForSnake(vector)) {
            spaceTree.position.x = spaceTree.position.x + 4;
            spaceTree.position.z = spaceTree.position.z + 4;
        }
